    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
              ...
              [InlineKeyboardButton("𝘼 𝙉 𝘿 𝙍 𝙊 𝙄 𝘿 ¦ اندوريد", url=f"t.me/U_Androld"),
              InlineKeyboardButton("𝐒𝐎𝐔𝐑𝐂𝐄🚨", url=f"t.me/UU_and_rold"),
                ],
              [InlineKeyboardButton("أضف لبوت لمجموعتك ✅", url=f"http://t.me/VPllllllbot?startgroup=new"),              
            ]
        ]
    )
    if m.sender_chat:
    ...
    if replied:
        if replied.video or replied.document:
            ...
            if chat_id in QUEUE:
                ...
                await loser.edit(" **جاري التشغيل انتظر قليلآ يقلبي🙂💛...**")
            ...
            if len(m.command) < 2:
                ...
                loser = await c.send_message(chat_id, " **جاري البحث انتظر قليلآ يحب💛🙂...**")
                    ...
                    if amort == 0:
                        ...
                        if chat_id in QUEUE:
                            ...
                            try:
                                ...
                                await loser.delete()
                                await m.reply_text(f"🚫 error قام احد مشرفي المجموعه بحظر الحساب المساعد برجاء رفع الحظر عنه @U_And_rold : `{ep}`")
                ...
                if veez == 0:
                    ...
                    if chat_id in QUEUE:
                        ...
                        try:
                            ...
                            await loser.delete()
                            await m.reply_text(f"🚫 خطاء قام احد مشرفي المجموعه بحظر الحساب المساعد برجاء رفع الحظر عنه @U_And_rold : `{ep}`")
...
async def vstream(c: Client, m: Message):
    ...
    if len(m.command) < 2:
        ...
        if len(m.command) == 2:
            ...
            Q = 720
            loser = await c.send_message(chat_id, " **تتم المعالجة انتظر قليلآ يقلبي💛🙂...**")
        ...
        if amort == 0:
            ...
            if chat_id in QUEUE:
                ...
                try:
                    ...
                    await loser.delete()
                    await m.reply_text(f"🚫 خطاء قام احد مشرفي المجموعه بحظر الحساب المساعد برجاء رفع الحظر لكي اعمل @U_And_rold : `{ep}`")

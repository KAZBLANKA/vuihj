...
@Client.on_message(
    command(["userbotjoin","دخل","انضم","نضم", f"userbotjoin@{BOT_USERNAME}"]) & ~filters.private & ~filters.bot
)
...
async def join_group(client, message):
    ...
    try:
        ...
        await message.reply_text(     
            ...
            "\n\n**أو تواصل مع المطور @U_Androld او أضف مساعدًا  @U_And_rold يدويًا إلى مجموعتك وحاول مرة أخرى**",
        )
        return
    await message.reply_text(
